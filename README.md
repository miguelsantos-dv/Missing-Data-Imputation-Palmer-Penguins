...
```
penguins_imputation.ipynb      # Main notebook: EDA, imputation, validation
penguins_inicial.csv           # Raw data w/ missing values — generated by the notebook (Power BI input)
penguins_imputado.csv          # Fully imputed dataset — generated by the notebook (Power BI input)
...
3. Open the notebook:
   ```bash
   jupyter notebook penguins_imputation.ipynb
   ```
